...
<html lang="fr">
  <head>
    <meta charset="utf-8" />
    <link rel="stylesheet" href="chapitre_1.css" />
  ...
  <body>
    <div id="bloc_page">
      ...
      <div id ="délimitation">
            ...
            <div id ="liens">
                    <a href="prologue.php?id=1"><img src="flèche2.png"  width="75" height="75" alt="deuxième flèche"></a>
                    <a href="sommaire.html"><img src="point.png" width="75" height="75" alt="point"></a>
                    <a href="chapitre_2.php?id=3"><img src="flèche.png"  width="75" height="75" alt="flèche"></a>                        
            </div>
            ...
            <div id = "coeur">
                ...
                Je vote <a href ="action.php?t=1&amp;id=2"><img src="vote.png" width="90" height="70" alt="je vote" /></a> 
            ...
            <?php while($c = $commentaires->fetch()) { ?>
              <section id="com">
               <b><?= $c['pseudo'] ?>:<p id="com_corps"></b> <?= $c['commentaire'] ?><br />Posté le <?= $c['date_creation'] ?></p>
